...
function readTag(filename, count) {
    ...
    $('#'+count+'Tag' + tcount).append("<input type='image' id='"+count+"deleteButton"+tcount+"' class='deleteButton' src='removeTagButton.png' alt='"+getTag+"'>");
...
function addTagsToDOM(dataArray)
{
    ...
    for (var count=0;count<mylength;count++)
    {
        ...
        for (tcount=0;tcount<taglength;tcount++){
          ...
          $('#'+count+'Tag' + tcount).append("<input type='image' id='"+count+"deleteButton"+tcount+"' class='deleteButton' src='removeTagButton.png' alt='"+getTag[tcount]+"'>");
