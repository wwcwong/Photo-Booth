...
//option/fav section
    ...
    $(change).append("<input type='button' class='button' value ='change tags' onclick='changethetag()' id='changetags"+count+"'/>");
...
//tag section
    ...
    $(temp5).append("<button class='addButton' id='addButton"+count+"' >Add to list</button>");
